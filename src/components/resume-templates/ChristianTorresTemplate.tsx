...
interface ChristianTorresTemplateProps {
  resumeData: ResumeData;
}

const ChristianTorresTemplate: React.FC<ChristianTorresTemplateProps> = ({ resumeData }) => {
  return (
    <div className="w-[210mm] min-h-[297mm] bg-white mx-auto border border-gray-200 shadow-sm">
      <div className="p-8">
        ...
        <div className="border-b border-gray-200 pb-6 mb-6">
          ...
          <h2 className="text-lg text-blue-600 mb-4">{resumeData.personalInfo.jobTitle}</h2>
...
export default ChristianTorresTemplate; 