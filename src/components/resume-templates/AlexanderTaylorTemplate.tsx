...
interface AlexanderTaylorTemplateProps {
  resumeData: ResumeData;
}

const AlexanderTaylorTemplate: React.FC<AlexanderTaylorTemplateProps> = ({ resumeData }) => {
  return (
    <div className="w-[210mm] min-h-[297mm] bg-white mx-auto border border-gray-200 shadow-sm">
      <div className="p-8">
        {/* Header */}
        <div className="border-b-2 border-green-200 pb-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{resumeData.personalInfo.fullName}</h1>
          <h2 className="text-lg text-green-600 mb-4">{resumeData.personalInfo.jobTitle}</h2>
          <div className="flex flex-wrap gap-4 text-sm text-gray-600">
            ...
            {resumeData.personalInfo.website && (
              <a href={resumeData.personalInfo.website} className="text-green-600 hover:underline">
                {resumeData.personalInfo.website}
              </a>
            )}
          </div>
        ...
        {resumeData.summary && (
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-3 border-b-2 border-green-200 pb-2">
...
export default AlexanderTaylorTemplate; 